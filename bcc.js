...
const SOURCE_WEEKLY_TASKS=[
  ...
  ["GSH-36",12,"AMAR / финмодель","Зафиксировать финансовую модель компенсации AMAR","Зафиксированы целевая выручка, фактическая выручка, формула компенсации, периодичность получения факта и механизм расчетов.","Команда проекта AMAR","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-37",13,"AMAR / договор","Проработать договор AMAR ↔ АТОМ","Согласована договорная конструкция АТОМ ↔ AMAR с моделью компенсации недополученной выручки и параметрами расчетов.","Команда проекта","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ...
  ["GSH-39",15,"AMAR / Яндекс Драйв","Проработать юридическую конструкцию AMAR и Яндекс Драйв","Юридическая схема AMAR и Яндекс Драйв согласована с Юлией Рябчиковой и командой.","Юлия Рябчикова / команда","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-40",16,"AMAR / отчетность","Определить источник фактической выручки автомобилей AMAR","Определены источник, периодичность и ответственный за получение фактической выручки автомобилей AMAR.","Команда","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."]
];
