...
// Загружаются только строки, где в колонке "Признак" указано "Штаб".
const SOURCE_WEEKLY_TASKS=[
  ["GSH-24",24,"Дополнительные задачи","Актуализировать 113 компаний в Альфа, с которыми работала предыдущая команда","Все 113 компаний проверены. По каждой принято решение: LOST или продолжить работу. Для продолжаемых проектов указан актуальный этап","Алексей","Не начато","Срок/период: В работу. Решение встречи 23.09.2026. На встрече озвучено около 112 компаний; в текущей задаче ранее зафиксировано 113."],
  ["GSH-25",25,"Дополнительные задачи","Разобрать 100 лидов в ЭЛМА, сгенерированных ИИ","По всем 100 лидам принято решение: закрыть как дисквалифицированные либо провести квалификацию. Статусы в ЭЛМА обновлены","Алексей","Не начато","Срок/период: В работу. Решение встречи 23.09.2026. Подтвержден приоритет обработки текущего массива около 100 лидов."],
  ["GSH-27",27,"B2B / бронирование","Настроить единый процесс Soft / Hard booking","В одной схеме зафиксированы Soft booking на этапе КП и Hard booking после договора; видны количество, даты, срок действия Soft booking, плановая дата выдачи, текущий статус и свободный остаток.","Иван","Не начато","Срок/период: Приоритетно. Решение встречи 23.09.2026."],
  ["GSH-28",28,"B2B / бронирование","Сделать прозрачный контроль изменений бронирования","Иван, B2B, Autosales и другие участники процесса одновременно видят реальный резерв, предварительный резерв, свободный сток и план выдач; изменения бронирования прослеживаются.","Иван","Не начато","Срок/период: Приоритетно. Решение встречи 23.09.2026."],
  ["GSH-29",29,"B2B / бронирование","Автоматизировать уведомления о завершении Soft booking","Менеджер получает уведомление об окончании срока Soft booking и подтверждает либо снимает резерв.","Иван / команда","Не начато","Срок/период: Следующий этап. Решение встречи 23.09.2026."],
  ["GSH-30",30,"B2B / лиды и воронка","Начать с горячих лидов из ELMA / сайта","Горячие входящие лиды из ELMA / сайта разобраны в первую очередь; по каждому зафиксированы результат и следующий шаг.","Алексей","Не начато","Срок/период: Сразу. Решение встречи 23.09.2026."],
  ["GSH-31",31,"B2B / лиды и воронка","Настроить понятное распределение лидов по вертикалям","Для каждого лида определена вертикаль по модели использования автомобиля и назначен ответственный.","Команда","Не начато","Срок/период: Приоритетно. Решение встречи 23.09.2026."],
  ["GSH-32",32,"B2B / лиды и воронка","Переносить в CMT только реальные коммерческие проекты","В CMT попадают только компании с реальным коммерческим проектом и потенциальной закупкой автомобилей; неподтвержденные идеи остаются лидами / гипотезами.","Команда","Не начато","Срок/период: Постоянно. Решение встречи 23.09.2026."],
  ["GSH-33",33,"B2B / отчетность","Обеспечивать показатели по лидам к понедельнику","К утру понедельника доступны: получено лидов, обработано, результат, а также конверсия до реальных проектов, сделок и объема автомобилей.","Иван / Алексей","Не начато","Срок/период: Еженедельно, к понедельнику. Решение встречи 23.09.2026."],
  ["GSH-34",34,"B2B / команда","Не принимать решение о дополнительных sales без фактической конверсии","Решение об увеличении команды принимается только после расчета фактической конверсии по текущей базе.","Команда","Не начато","Срок/период: После обработки текущей базы. Решение встречи 23.09.2026."],
  ["GSH-35",35,"B2B / проекты","Прорабатывать крупные реальные проекты после квалификации","После квалификации крупный реальный проект передан Михаилу / команде и по нему зафиксирован следующий шаг.","Михаил / команда","Не начато","Срок/период: Постоянно. Решение встречи 23.09.2026."],
  ["GSH-36",36,"AMAR / финмодель","Зафиксировать финансовую модель компенсации AMAR","Зафиксированы целевая выручка, фактическая выручка, формула компенсации, периодичность получения факта и механизм расчетов.","Команда проекта AMAR","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-37",37,"AMAR / договор","Проработать договор AMAR ↔ АТОМ","Согласована договорная конструкция АТОМ ↔ AMAR с моделью компенсации недополученной выручки и параметрами расчетов.","Команда проекта","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-38",38,"Яндекс Драйв / промокоды","Проработать механику АТОМ ↔ Яндекс Драйв по промокодам","Определены выпуск и учет использованных промокодов, идентификация клиента и связи с ATOM ID, ELMA, Альфа-Авто и другими системами; оплачиваются фактически использованные промокоды.","Команда проекта","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-39",39,"AMAR / Яндекс Драйв","Проработать юридическую конструкцию AMAR и Яндекс Драйв","Юридическая схема AMAR и Яндекс Драйв согласована с Юлией Рябчиковой и командой.","Юлия Рябчикова / команда","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."],
  ["GSH-40",40,"AMAR / отчетность","Определить источник фактической выручки автомобилей AMAR","Определены источник, периодичность и ответственный за получение фактической выручки автомобилей AMAR.","Команда","Не начато","Срок/период: В работу. Решение встречи 23.09.2026."]
];
  ...
  SOURCE_WEEKLY_TASKS.forEach(r=>{
    ...
    if(t){
      ...
      list.push({
        ...
        status:sourceStatus||'Не начато',priority:'Средний',progress:0,startDate:'',dueDate:'',
