...
if(!document.getElementById('template-v3-style')){
  ...
  style.textContent=`
    ...
    .distribution-table .b2b-group-row{cursor:pointer;user-select:none}.distribution-table .b2b-group-row td{background:#fbfcfd!important}.distribution-table .b2b-group-row:hover td{background:#f4f6f8!important}.distribution-table .b2b-group-name{position:relative;padding-left:32px!important}.distribution-table .b2b-group-name strong{font-weight:800!important;font-style:italic!important;color:#3B1D5A!important}.distribution-table .b2b-group-name:before{content:'▾';position:absolute;left:12px;top:50%;transform:translateY(-50%);font-size:15px;color:#667085;font-weight:700}.distribution-table .b2b-group-row.b2b-group-collapsed .b2b-group-name:before{content:'▸'}.distribution-table .b2b-group-row:focus{outline:2px solid #98a2b3;outline-offset:-2px}
